	...
	*/
	...
	{	
		...
		*/
		...
		$this->loader->add_action('manage_shop_order_posts_custom_column',$this->plugin_admin,'add_print_actions',10,2); /* Add print action buttons to action column */
		$this->loader->add_action('manage_woocommerce_page_wc-orders_custom_column',$this->plugin_admin,'add_print_actions',10,2);
