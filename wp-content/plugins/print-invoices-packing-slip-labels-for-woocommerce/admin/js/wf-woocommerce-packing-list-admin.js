		...
		$("#doaction, #doaction2").on('click',function(e){
	        ...
	        if($.inArray(action,wf_pklist_params.bulk_actions) !== -1 ) 
	        {
	        	...
	        	}else
	        	{
					...
					if('print_invoice' === action){
						// Print invoice has been moved outside of the action div, so we take download invoice confirmation
						var confirmation_needed_ord = $('.wf_pklist_confirm_download_invoice');
					}else{
